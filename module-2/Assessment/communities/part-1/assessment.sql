...
SELECT name, address FROM properties WHERE latitude < 0 AND created BETWEEN '2019-06-01' AND '2019-06-30'
...
SELECT created, COUNT(created) FROM properties GROUP BY created
...
SELECT communities.name, live, properties.address FROM communities JOIN properties ON communities.id = properties.community_id WHERE communities.created >= '2019-10-01'
