<template>
  <div id="app">
    ...
    <shopping-search v-on:filter-tasks="handleSearch"></shopping-search>
    <shopping-list title="Groceries item's" v-bind:items="groceries" v-bind:search="search" ></shopping-list>
    <shopping-list title="Costco item's" v-bind:items="costco" v-bind:search="search" ></shopping-list>
    <shopping-list title="Target item's" v-bind:items="target" v-bind:search="search" ></shopping-list>
  </div>
</template>
